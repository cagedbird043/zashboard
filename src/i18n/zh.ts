...
const zh: LANG_MESSAGE = {
  ...
  tailnetDescription: '查看 sing-box 内置 Tailscale 端点和设备。',
  tailnetUnavailableDescription:
    '当前后端没有暴露 Tailnet API，或配置中没有可用的 Tailscale endpoint。',
  endpoints: '端点',
  running: '运行中',
  loading: '加载中',
  local: '本地',
  ...
  partial: '部分',
  lastUpdated: '最后刷新',
  noTailscaleEndpoints: '没有发现 Tailscale 端点。',
  tailnetNetwork: '网络',
  magicDNS: 'MagicDNS',
  login: '登录',
  selfDevice: '本机',
  peers: '对端设备',
  noSelfDevice: '没有本机设备信息。',
  noPeers: '没有对端设备。',
  online: '在线',
  offline: '离线',
